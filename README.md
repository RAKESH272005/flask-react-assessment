...
`Full-Stack` starter provided by [App Generator](https://app-generator.dev/) on top of **[Berry Dashboard](https://app-generator.dev/product/berry-dashboard/)** design. 
...
The **React** Design is crafted by [CodedThemes](https://app-generator.dev/agency/codedthemes/) on top of `MUI` Library.
...
## ✨ `React` [Berry Dashboard](https://app-generator.dev/product/berry-dashboard/)
...
## [React Berry PRO Full-Stack](https://app-generator.dev/product/berry-dashboard-pro/fullstack/react/)
...
- 👉 [React Berry PRO Full-Stack](https://app-generator.dev/product/berry-dashboard-pro/fullstack/react/) - `Product Page`
...
---
**[Flask React Berry](https://appseed.us/product/berry-dashboard/api-server-flask/react/)** - `Full-Stack` Seed project provided by **[App-Generator](https://app-generator.dev/)**.
